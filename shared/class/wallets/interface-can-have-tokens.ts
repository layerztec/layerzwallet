...
/**
 * Required property names for InterfaceCanHaveTokens.
 * TypeScript will error if these don't match the interface keys.
 */
const REQUIRED_PROPERTIES = ['_lastTokensFetch'] as const satisfies ReadonlyArray<keyof InterfaceCanHaveTokens>;
