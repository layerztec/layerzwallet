...
function createMedia(media) {
  return (0, import_web2.setupMatchMedia)(matchMedia), media;
}
...
var tokens = {
  size: {
    ...
    true: 16,
    // Using 16 (equivalent to $4) as the default size
    $true: 16
  },
  space: {
    0: 0,
    ...
    true: 16,
    // Using 16 (equivalent to $4) as the default space
    $true: 16
  },
  radius: {
    0: 0,
