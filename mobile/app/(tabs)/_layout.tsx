    ...
    return (
      ...
      >
        <NativeTabs.Trigger name="home" disableAutomaticContentInsets={Platform.OS === 'android'}>
          ...
          <NativeTabs.Trigger.Icon sf="house.fill" src={require('@/assets/images/ui/layerz.png')} md="home" />
        </NativeTabs.Trigger>
        <NativeTabs.Trigger name="swaps" disableAutomaticContentInsets={Platform.OS === 'android'}>
          ...
          <NativeTabs.Trigger.Icon sf="arrow.triangle.2.circlepath" src={require('@/assets/images/ui/swap.png')} md="swap_horiz" />
        </NativeTabs.Trigger>
        <NativeTabs.Trigger name="explorer" disableAutomaticContentInsets={Platform.OS === 'android'}>
          ...
          <NativeTabs.Trigger.Icon sf="globe" src={require('@/assets/images/ui/explorer.png')} md="public" />
        </NativeTabs.Trigger>
      </NativeTabs>
    );
  }
