...
import { BlurTargetContextProvider } from '@/src/hooks/BlurTargetContext';
...
export default function Home() {
  ...
  useEffect(() => {
    return () => {
      homeBlurTargetRef.current = null;
    };
  }, []);
  ...
  return (
    <GestureHandlerRootView style={styles.gestureHandlerRoot}>
      <BlurTargetContextProvider blurTargetRef={homeBlurTargetRef}>
        <View style={styles.gestureHandlerRoot}>
...
const styles = StyleSheet.create({
  ...
  /** Renders after BlurTargetView so header BlurView mounts after scroll (Android). */
  modalHeaderOverlay: {
    position: 'absolute',
    top: 0,
    left: 0,
  ...
  /** Android BlurView blurs this subtree only; must not wrap the header that contains BlurView */
  blurScrollTarget: {
    flex: 1,
    minHeight: 0,
  },
