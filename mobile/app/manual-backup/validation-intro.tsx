...
export default function ManualBackupValidationIntro() {
        ...
        <SafeAreaView style={styles.safeAreaView}>
          <View style={styles.logoContainer}>
            <Animated.View style={[imageTransition]}>
              <Image source={require('@/assets/images/ui/validation-checklist.png')} style={styles.image} />
            </Animated.View>
          </View>
          ...
          <View style={styles.buttonSection}>
            <Animated.View style={[styles.buttonContainer, buttonTransition]}>
              <TouchableOpacity style={styles.button} onPress={handleContinue} testID="ValidationIntroContinueButton">
