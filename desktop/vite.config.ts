...
export default defineConfig(({ mode }) => {
  ...
  const breezApiKey = process.env.EXPO_PUBLIC_BREEZ_API_KEY ?? env.EXPO_PUBLIC_BREEZ_API_KEY ?? '';
  const sharedRoot = path.resolve(__dirname, 'src/mainview/shared-link');

  // Inline every EXPO_PUBLIC_* var (shell overrides .env files) so shared code reading
  // process.env.EXPO_PUBLIC_* works. Mirrors Expo (mobile) and ext's webpack DefinePlugin,
  // which both expose all EXPO_PUBLIC_* vars; here Vite needs each one declared in `define`.
  ...
  return {
    ...
    base: './',
    envDir: __dirname,
    plugins: [react(), wasm(), topLevelAwait(), wasmMimeTypePlugin(), breezApiKeyPlugin(() => breezApiKey)],
    assetsInclude: ['**/*.wasm'],
    root: 'src/mainview',
    resolve: {
      ...
      alias: [
        ...
        {
          find: 'bignumber.js',
          replacement: path.resolve(__dirname, 'node_modules/bignumber.js/bignumber.mjs'),
        },
        {
          find: 'ethers',
        ...
        },
        {
          ...
          replacement: path.resolve(__dirname, 'node_modules/@noble/hashes/scrypt.js'),
        },
        {
          find: '@noble/hashes/sha256',
          replacement: path.resolve(__dirname, 'node_modules/@noble/hashes/sha256.js'),
        },
        {
          find: '@noble/hashes/utils',
          replacement: path.resolve(__dirname, 'node_modules/@noble/hashes/esm/utils.js'),
        },
        {
          find: '@buildonspark/spark-sdk',
          replacement: path.resolve(__dirname, 'node_modules/@buildonspark/spark-sdk/dist/index.browser.js'),
        },
        {
          find: '@noble/hashes/legacy',
          replacement: path.resolve(__dirname, 'src/mainview/shims/noble-hashes-legacy.js'),
        },
        { find: '@shared', replacement: sharedRoot },
        {
          find: '@shared/features/mcp/modules/mcp-activity-log',
          replacement: path.resolve(sharedRoot, 'features/mcp/modules/mcp-activity-log.ts'),
        },
        {
          find: '@shared/features/mcp/modules/tunnel',
          replacement: path.resolve(sharedRoot, 'features/mcp/modules/tunnel.ts'),
        },
        { find: '@', replacement: path.resolve(__dirname, 'src/mainview') },
        {
          find: 'expo/fetch',
          replacement: path.resolve(__dirname, 'src/mainview/modules/expo-fetch-shim.ts'),
        },
        {
          find: '@arkade-os/sdk/adapters/expo',
          replacement: path.resolve(__dirname, 'node_modules/@arkade-os/sdk/dist/adapters/expo.js'),
        },
        {
          find: 'events',
        ...
        {
          find: 'assert',
          replacement: path.resolve(__dirname, 'node_modules/assert/build/assert.js'),
        },
        {
          find: 'crypto',
          replacement: path.resolve(__dirname, 'node_modules/crypto-browserify/index.js'),
        },
        {
          find: 'stream',
          replacement: path.resolve(__dirname, 'node_modules/stream-browserify/index.js'),
        },
        {
          find: 'buffer',
        ...
        {
          find: 'path',
          replacement: path.resolve(__dirname, 'node_modules/path-browserify/index.js'),
        },
        {
          find: 'vm',
        ...
        {
          find: 'randomfill',
          replacement: path.resolve(__dirname, 'src/mainview/shims/randomfill.js'),
        },
        {
        ...
        {
          find: 'zlib',
          replacement: path.resolve(__dirname, 'node_modules/browserify-zlib/lib/index.js'),
        },
        {
          find: 'http',
          replacement: path.resolve(__dirname, 'node_modules/stream-http/index.js'),
        },
        {
          find: 'https',
          replacement: path.resolve(__dirname, 'node_modules/stream-http/index.js'),
        ...
        {
          find: 'timers',
          replacement: path.resolve(__dirname, 'node_modules/timers-browserify/main.js'),
        },
        {
          find: 'util',
    ...
    define: {
      ...expoPublicDefines,
      // Keep Breez explicit/last: guarantees a '' fallback (never undefined) for the adapter + warning.
