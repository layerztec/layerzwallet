...
const AppContent: React.FC = () => {
      ...
      case EStep.INTRO:
        return (
          <Routes>
            ...
            <Route
              path="/onboarding-create-wallet-intro"
              element={<OnboardingCreateWalletIntro />}
            />
            <Route
              path="/onboarding-create-wallet"
              element={<OnboardingCreateWallet />}
            />
            <Route
      ...
      case EStep.PASSWORD:
        return (
          <Routes>
            ...
            <Route
              path="*"
              element={<Navigate to="/onboarding-create-password" replace />}
            />
          </Routes>
        );
      ...
      case EStep.UNLOCK_PASSWORD:
        return (
          <Routes>
            ...
            <Route
              path="*"
              element={<Navigate to="/unlock-password" replace />}
            />
          </Routes>
        );
      ...
      case EStep.TOS:
        return (
          <Routes>
            ...
            <Route
              path="*"
              element={<Navigate to="/onboarding-tos" replace />}
            />
          </Routes>
        );
          ...
          <>
            ...
            <Routes>
              <Route element={<WalletShell />}>
                ...
                <Route
                  path="/receive-on-lightning-address"
                  element={<ReceiveOnLightningAddress />}
                />
                <Route
                  path="/action-popup-modal"
                  element={<ActionPopupModal />}
                />
                <Route
                  path="/mcp-permissions-modal"
                  element={<McpPermissionsModal />}
                />
                <Route
                  path="/mcp-tunnel-url-modal"
                  element={<McpTunnelUrlModal />}
                />
  ...
  const appClass =
    isWalletShell || isUnlock ? "App App--wallet" : "App App--onboarding";
