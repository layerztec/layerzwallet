...
export const AskMnemonicContext = createContext<IAskMnemonicContext>({
  askMnemonic: (): Promise<string> =>
    Promise.reject("askMnemonic: this should never happen"),
});
 ...
 */
export const AskMnemonicContextProvider: React.FC<{ children: ReactNode }> = (
  props,
) => {
  ...
  const onOkClick = async () => {
    ...
    try {
      ...
      assert(
        ...
        "Mnemonic not encrypted, reinstall the extension",
      );
          ...
          <div style={{ textAlign: "center", minWidth: "300px" }}>
            ...
            {error && (
              <div style={{ marginBottom: "15px" }}>
                <ThemedText style={{ color: "#dc3545", fontSize: "14px" }}>
                  {error}
                </ThemedText>
              </div>
            )}
            ...
            {isLoading && (
              <div style={{ marginBottom: "15px" }}>
                <ThemedText style={{ color: "#666", fontSize: "14px" }}>
                  Decrypting wallet...
                </ThemedText>
              </div>
            )}
