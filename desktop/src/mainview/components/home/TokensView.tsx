...
export const TokensView = memo(
  forwardRef<{ refresh: () => void }, TokensViewProps>(({ onTokenPress, selectedToken }, ref) => {
    ...
    return (
      <>
        <SectionContainer title="Tokens" className={!hasVisibleTokens ? 'home-section-hidden' : undefined}>
