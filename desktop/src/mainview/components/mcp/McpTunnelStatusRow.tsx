...
export const McpTunnelStatusRow: React.FC = () => {
  ...
  const dotClass =
    status === "connected"
      ? "mcp-tunnel-dot--active"
      : status === "connecting"
        ? "mcp-tunnel-dot--connecting"
        : "mcp-tunnel-dot--inactive";
  ...
  return (
    <section className="mcp-tunnel-section" aria-label="AI agent tunnel status">
      <div className="mcp-tunnel-row">
        ...
        <button
          type="button"
          className="mcp-tunnel-detail-btn"
          onClick={() => navigate("/mcp-tunnel-url-modal")}
          aria-label="Agent tunnel URL"
        >
